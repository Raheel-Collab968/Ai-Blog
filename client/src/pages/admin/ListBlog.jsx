...
const fetchBlogs = async () => {
  try {
    ...
    console.log("API response:", data); // 👀 Check what's coming from the backend

    if (data.success) {
      console.log("Fetched blogs:", data.blogs); // 👀 Should be an array
      setBlogs(data.blogs || []); // fallback to [] just in case
    } else {
