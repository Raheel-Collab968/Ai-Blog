  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/3'>
        ...
        py-10 border-b border-gray-500/30 text-gray-500'>
            <div>
                <a href="#" ><img src={assets.logo} alt="logo" className='w-32 sm:w-44 cursor-pointer' /></a>
                <p className='max-w-[410px] mt-6'>Lorem ipsum dolor sit amet elit. 
                Quo beatae, perferendis accusamus ipsum molestiae dolorum est
                id cum laborum.</p>
            </div>
